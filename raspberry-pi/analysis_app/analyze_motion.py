...
class motionAnalyzer:
    ...
    def uploadImage(self, imagePath, imageName):
        ...
        s3.upload_file(imagePath, BUCKET_NAME, imageName)
    ...
    def processContent(self):
        ...
        for obj in movingObjectCounter.movingObjects:
            ...
            if obj.midPointPosition != None:
                ...
                print("Uploading Image {}".format(processedObject.image))
                self.uploadImage(outputImage, processedObject.image)
                pk = inputVideoDateTime.strftime("%Y_%m_%d")
                sk = inputVideoDateTime.strftime("%H_%M_%S") + "-{}".format(processedObject.id)
                print("Upload Data Status: {}".format(self.uploadData(processedObject.getItem(pk, sk))))
