...
class Position(object):
    ...
    def __str__(self):
        string = '{{"point": {{"x":{x}, "y":{y}}},'.format(x=self.point[0], y=self.point[1])
        string += '"frame-number":{},'.format(self.frameNumber)
        string += '"sample-zone":{}}}'.format(self.inSampleZone)
